...
import { Menu, X, Home, LayoutDashboard, UploadCloud, LogOut, User as UserIcon, BookOpen } from 'lucide-vue-next';
        ...
        <nav class="bg-gray-800 border-b border-gray-700 sticky top-0 z-50">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <Link :href="route('vocabulary.index')" :class="['inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition duration-150 ease-in-out', route().current('vocabulario') ? 'border-yellow-400 text-white' : 'border-transparent text-gray-400 hover:text-gray-300 hover:border-gray-500']">
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="sm:hidden bg-gray-800 border-t border-gray-700">
                ...
                <div class="pt-4 pb-1 border-t border-gray-700">
                    ...
                    <div class="space-y-1">
                        <Link :href="route('logout')" method="post" as="button" class="block w-full text-left pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700 transition duration-150 ease-in-out">
                            Cerrar Sesión
                        </Link>
                    </div>
                </div>
